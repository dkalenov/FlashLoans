...
const provider = new ethers.providers.JsonRpcProvider(
  "https://eth-mainnet.g.alchemy.com/v2/3hd9Izfl4SLczdTYWInRZ_9Khn0VOBp4"
);
...
async function getPrice(addressFrom, addressTo, amountInHuman) {
  ...
  // Output the amount
  const amount = ethers.utils.formatUnits(quoteAmountOut.toString(), 18); // 18 -amount of decimals
  return amount;
}
